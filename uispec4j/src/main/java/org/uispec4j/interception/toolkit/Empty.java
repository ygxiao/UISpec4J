...
public final class Empty {
  ...
  static class WindowPeer implements java.awt.peer.WindowPeer {
    public void toBack() {
    }
  ...
  static class FramePeer extends WindowPeer implements java.awt.peer.FramePeer {
    public int getState() {
      return 0;
    }
  ...
  static class DialogPeer extends WindowPeer implements java.awt.peer.DialogPeer {
    public void setResizable(boolean resizeable) {
    }
